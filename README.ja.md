...
- Fable 5などモデル固有の週間上限がある場合、5時間枠・週間枠・追加枠と合わせて表示
- 残り10%未満で赤色に変化
- Claudeの返答完了後に自動更新

### Claude ステータス

claude.ai の稼働状況をリアルタイムで監視します。

- 緑=正常・黄=パフォーマンス低下・オレンジ=一部障害・赤=大規模障害
- ポップアップには常にステータスが色付きドットで表示され、インシデント発生中はインシデント名がリンクで表示される
